...
import type { BatchSaleItem } from "./types";

interface BatchSaleItemRowProps {
  item: BatchSaleItem;
  index: number;
  mfcSellerId: string | null; // From top-level selection
  updateItem: (
    id: string,
...
export const BatchSaleItemRow: React.NamedExoticComponent<BatchSaleItemRowProps> = memo(
  ({
    item,
    index,
    mfcSellerId,
...
BatchSaleItemRow.displayName = "BatchSaleItemRow";
