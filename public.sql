...
\restrict 6G3q7YhOPBv6z5lJ5lw8jpOioJAenP0z1V8Ze0XAOANDfbkjhZdZLReGgO3KnW3
...
--
-- Name: default_role; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.default_role OWNER TO postgres;
...
--
-- Name: _get_current_staff_profile_by_role(public.staff_type); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public._get_current_staff_profile_by_role(p_role public.staff_type) OWNER TO postgres;

--
-- Name: _internal_create_sale_and_update_stock(uuid, uuid, uuid, jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public._internal_create_sale_and_update_stock(p_daily_bill_id uuid, p_chalan_id uuid, p_staff_id uuid, p_sale_item jsonb) OWNER TO postgres;

--
-- Name: _internal_validate_stock_availability(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public._internal_validate_stock_availability(p_sale_items jsonb) OWNER TO postgres;

--
-- Name: approve_user(uuid, public.default_role, public.user_type, jsonb, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.approve_user(p_registration_id uuid, p_default_role public.default_role, p_user_type public.user_type, p_address jsonb, p_profile_photo_url text) OWNER TO postgres;

--
-- Name: authorize_staff(text[]); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.authorize_staff(p_required_roles text[]) OWNER TO postgres;
...
--
-- Name: cleanup_pending_registrations(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.cleanup_pending_registrations() OWNER TO postgres;

--
-- Name: create_auction_sale(uuid, jsonb, numeric, numeric, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_auction_sale(p_seller_id uuid, p_sale_items jsonb, p_commission_percentage numeric, p_paid_amount numeric, p_chalan_date date) OWNER TO postgres;

--
-- Name: create_floor_sale(jsonb, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_floor_sale(p_sale_items jsonb, p_sale_date date) OWNER TO postgres;

--
-- Name: create_quote(uuid, uuid, date, text, jsonb, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_quote(p_customer_id uuid, p_assigned_mfc_seller_id uuid, p_delivery_date date, p_quote_number text, p_items jsonb, p_notes text) OWNER TO postgres;

--
-- Name: create_sale_for_single_customer(uuid, jsonb, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_sale_for_single_customer(p_buyer_id uuid, p_sale_items jsonb, p_sale_date date) OWNER TO postgres;

--
-- Name: create_seller_batch_sale(uuid, jsonb, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_seller_batch_sale(p_mfc_seller_id uuid, p_sale_items jsonb, p_sale_date date) OWNER TO postgres;

--
-- Name: create_stock_batches(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_stock_batches(p_batches jsonb) OWNER TO postgres;

--
-- Name: create_user_as_staff(text, text, text, text, text, public.user_type, public.default_role, jsonb, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.create_user_as_staff(p_email text, p_password text, p_full_name text, p_business_name text, p_phone text, p_user_type public.user_type, p_default_role public.default_role, p_address jsonb, p_profile_photo_url text) OWNER TO postgres;

--
-- Name: debug_rls_status(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.debug_rls_status() OWNER TO postgres;

--
-- Name: get_auth_id_or_default(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_auth_id_or_default() OWNER TO postgres;

--
-- Name: get_current_admin_profile(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_current_admin_profile() OWNER TO postgres;

--
-- Name: get_current_manager_info(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_current_manager_info() OWNER TO postgres;

--
-- Name: get_current_mfc_seller_profile(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_current_mfc_seller_profile() OWNER TO postgres;

--
-- Name: get_my_staff_role(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_my_staff_role() OWNER TO postgres;

--
-- Name: get_my_user_id(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_or_create_daily_bill(uuid, date, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_or_create_daily_bill(p_customer_id uuid, p_bill_date date, p_created_by uuid) OWNER TO postgres;

--
-- Name: get_recently_updated(text, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_recently_updated(p_table_name text, p_minutes integer) OWNER TO postgres;

--
-- Name: get_staff_profile(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_staff_profile(p_staff_id uuid) OWNER TO postgres;
...
--
-- Name: handle_audit_stamps(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.handle_audit_stamps() OWNER TO postgres;
...
--
-- Name: initialize_user_balance(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.initialize_user_balance() OWNER TO postgres;

--
-- Name: log_quote_advance(uuid, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.log_quote_advance(p_quote_id uuid, p_amount_paid numeric) OWNER TO postgres;

--
-- Name: mark_deletions_synced(uuid[]); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.mark_deletions_synced(p_deletion_ids uuid[]) OWNER TO postgres;

--
-- Name: notify_user_of_record_change(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.notify_user_of_record_change() OWNER TO postgres;

--
-- Name: prevent_last_default_admin_removal(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.prevent_last_default_admin_removal() OWNER TO postgres;

--
-- Name: purchase_stock_from_seller(uuid, numeric, uuid, jsonb, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.purchase_stock_from_seller(p_seller_id uuid, p_commission_percentage numeric, p_mfc_seller_id_to_assign uuid, p_purchase_items jsonb, p_purchase_date date) OWNER TO postgres;

--
-- Name: purge_old_deletions(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.purge_old_deletions() OWNER TO postgres;

--
-- Name: register_fcm_token(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.register_fcm_token(p_device_token text) OWNER TO postgres;

--
-- Name: reject_registration(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.reject_registration(p_registration_id uuid) OWNER TO postgres;

--
-- Name: set_stock_batch_code(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.set_stock_batch_code() OWNER TO postgres;

--
-- Name: submit_lump_sum_payment(uuid, numeric, public.payment_method_enum, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.submit_lump_sum_payment(p_customer_id uuid, p_total_amount numeric, p_payment_method public.payment_method_enum, p_payment_date date) OWNER TO postgres;

--
-- Name: submit_seller_payout(uuid, numeric, public.payment_method_enum, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.submit_seller_payout(p_chalan_id uuid, p_amount numeric, p_payment_method public.payment_method_enum, p_payment_date date) OWNER TO postgres;

--
-- Name: submit_specific_bill_payment(uuid, numeric, public.payment_method_enum, date); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.submit_specific_bill_payment(p_daily_bill_id uuid, p_amount numeric, p_payment_method public.payment_method_enum, p_payment_date date) OWNER TO postgres;

--
-- Name: sync_system_config_default_admin(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.sync_system_config_default_admin() OWNER TO postgres;

--
-- Name: track_deletion(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.track_deletion() OWNER TO postgres;

--
-- Name: trigger_recalculate_financials_from_sale(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trigger_recalculate_financials_from_sale() OWNER TO postgres;

--
-- Name: trigger_set_chalan_calculations(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trigger_set_chalan_calculations() OWNER TO postgres;

--
-- Name: trigger_set_sale_transaction_amount(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.trigger_set_sale_transaction_amount() OWNER TO postgres;
...
--
-- Name: update_seller_balance(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_seller_balance() OWNER TO postgres;
...
--
-- Name: chalans; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.chalans OWNER TO postgres;

--
-- Name: daily_bills; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.daily_bills OWNER TO postgres;

--
-- Name: mfc_staff; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.mfc_staff OWNER TO postgres;
...
--
-- Name: buyer_sales_view; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.buyer_sales_view OWNER TO postgres;

--
-- Name: chalan_number_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.chalan_number_seq OWNER TO postgres;

--
-- Name: customer_balance; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.customer_balance OWNER TO postgres;
...
--
-- Name: daily_batch_sequence; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.daily_batch_sequence OWNER TO postgres;

--
-- Name: daily_bill_counters; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.daily_bill_counters OWNER TO postgres;

--
-- Name: seller_balance; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.seller_balance OWNER TO postgres;
...
--
-- Name: dashboard_stats_for_admin; Type: MATERIALIZED VIEW; Schema: public; Owner: postgres
--
...
ALTER MATERIALIZED VIEW public.dashboard_stats_for_admin OWNER TO postgres;

--
-- Name: deleted_records; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.deleted_records OWNER TO postgres;

--
-- Name: fcm_device_tokens; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.fcm_device_tokens OWNER TO postgres;

--
-- Name: mfc_batch_bill_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.mfc_batch_bill_seq OWNER TO postgres;

--
-- Name: mfc_floor_sale_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.mfc_floor_sale_seq OWNER TO postgres;

--
-- Name: mfc_seller_sales_view; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.mfc_seller_sales_view OWNER TO postgres;

--
-- Name: mfc_single_bill_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.mfc_single_bill_seq OWNER TO postgres;

--
-- Name: public_registrations; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.seller_payments OWNER TO postgres;

--
-- Name: seller_sales_view; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.seller_sales_view OWNER TO postgres;
...
--
-- Name: chalans chalans_chalan_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: chalans chalans_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customer_balance customer_balance_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bill_counters daily_bill_counters_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills daily_bills_bill_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills daily_bills_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: deleted_records deleted_records_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: deleted_records deleted_records_table_record_owner_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fcm_device_tokens fcm_device_tokens_device_token_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fcm_device_tokens fcm_device_tokens_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff mfc_staff_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations public_registrations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: seller_balance seller_balance_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments seller_payments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches stock_batches_batch_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: system_config system_config_default_admin_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_chalans_chalan_date; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_chalans_mfc_seller_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_chalans_seller_date; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_chalans_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_chalans_unpaid; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_chalans_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_balance_current_due; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_payments_bill; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_payments_daily_bill_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_customer_payments_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_daily_bills_bill_date; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_daily_bills_customer_date; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_daily_bills_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_daily_bills_unpaid; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_daily_bills_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_dashboard_stats_singleton; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deleted_records_deleted_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deleted_records_owner_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deleted_records_synced; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deleted_records_table_name; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_deleted_records_table_record; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_fcm_device_tokens_user_auth_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_mfc_staff_active; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_mfc_staff_is_active; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_mfc_staff_role; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_mfc_staff_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_public_registrations_status_created_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_quote_items_product_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_quotes_assigned_mfc_seller_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_quotes_customer; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_quotes_delivery_date; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_quotes_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_sale_transactions_bill; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_sale_transactions_chalan; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_sale_transactions_stock_batch_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_sale_transactions_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_seller_balance_current_due; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_seller_payments_chalan; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_seller_payments_chalan_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_seller_payments_payment_date; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_seller_payments_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stock_batches_available; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stock_batches_current_weight; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stock_batches_mfc_seller; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stock_batches_product; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_stock_batches_updated_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff_one_default_admin_only; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff enforce_last_admin_exists; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches handle_batch_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills handle_bill_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: chalans handle_chalan_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments handle_customer_payment_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: products handle_product_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: quotes handle_quote_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations handle_registration_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions handle_sale_transaction_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments handle_seller_payment_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff handle_staff_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: users handle_user_update; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: users initialize_balance_for_new_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills on_bill_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: chalans on_chalan_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments on_customer_payment_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: deleted_records on_delete_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: quotes on_quote_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: quote_items on_quote_item_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions on_sale_tx_change_notify_users; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments on_seller_payment_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches on_stock_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: users on_user_change_notify_user; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches set_batch_code_trigger; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: chalans track_chalan_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments track_customer_payment_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills track_daily_bill_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: products track_product_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: quotes track_quote_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: quote_items track_quote_item_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations track_registration_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions track_sale_transaction_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments track_seller_payment_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff track_staff_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches track_stock_batch_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: users track_user_deletion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions trigger_recalc_parents; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: chalans trigger_set_chalan_calcs; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions trigger_set_sale_amount; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff trigger_sync_default_admin_on_staff_change; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills trigger_update_customer_balance_bill; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments trigger_update_customer_balance_payment; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: chalans trigger_update_seller_balance_chalan; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments trigger_update_seller_balance_payment; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: chalans chalans_mfc_seller_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: chalans chalans_seller_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customer_balance customer_balance_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments customer_payments_daily_bill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills daily_bills_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fcm_device_tokens fcm_device_tokens_user_auth_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: chalans fk_chalans_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments fk_customer_payments_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills fk_daily_bills_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: system_config fk_default_admin; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: system_config fk_mfc_stock_buyer; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: products fk_products_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: quotes fk_quotes_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions fk_sale_transactions_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments fk_seller_payments_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches fk_stock_batches_created_by_mfc_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches fk_stock_batches_mfc_seller; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff mfc_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations public_registrations_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations public_registrations_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: quotes quotes_assigned_mfc_seller_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions sale_transactions_chalan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions sale_transactions_daily_bill_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions sale_transactions_stock_batch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: seller_balance seller_balance_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments seller_payments_chalan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches stock_batches_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: chalans Admin full access on chalans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_balance Admin full access on customer_balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments Admin full access on customer_payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bill_counters Admin full access on daily_bill_counters; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills Admin full access on daily_bills; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: deleted_records Admin full access on deleted_records; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: fcm_device_tokens Admin full access on fcm_device_tokens; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff Admin full access on mfc_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products Admin full access on products; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations Admin full access on public_registrations; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quote_items Admin full access on quote_items; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quotes Admin full access on quotes; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions Admin full access on sale_transactions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_balance Admin full access on seller_balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments Admin full access on seller_payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches Admin full access on stock_batches; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: system_config Admin full access on system_config; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Admin full access on users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations Anyone can insert registration; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff Authenticated read access on mfc_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products Authenticated read access on products; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: system_config Authenticated read access on system_config; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quotes MFC Seller read assigned quotes; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: chalans MFC Seller read own chalans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions MFC Seller read own sale transactions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches MFC Seller read own stock batches; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quote_items MFC Seller read quote items; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: chalans Manager insert access on chalans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_balance Manager insert access on customer_balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments Manager insert access on customer_payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bill_counters Manager insert access on daily_bill_counters; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills Manager insert access on daily_bills; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: deleted_records Manager insert access on deleted_records; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: fcm_device_tokens Manager insert access on fcm_device_tokens; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products Manager insert access on products; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations Manager insert access on public_registrations; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quote_items Manager insert access on quote_items; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quotes Manager insert access on quotes; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions Manager insert access on sale_transactions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_balance Manager insert access on seller_balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments Manager insert access on seller_payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches Manager insert access on stock_batches; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: system_config Manager insert access on system_config; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Manager insert access on users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: chalans Manager read access on chalans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_balance Manager read access on customer_balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments Manager read access on customer_payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bill_counters Manager read access on daily_bill_counters; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills Manager read access on daily_bills; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: deleted_records Manager read access on deleted_records; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: fcm_device_tokens Manager read access on fcm_device_tokens; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: mfc_staff Manager read access on mfc_staff; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products Manager read access on products; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations Manager read access on public_registrations; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quote_items Manager read access on quote_items; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quotes Manager read access on quotes; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions Manager read access on sale_transactions; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_balance Manager read access on seller_balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments Manager read access on seller_payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: stock_batches Manager read access on stock_batches; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: system_config Manager read access on system_config; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Manager read access on users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users Manager update access on users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: chalans User read own chalans; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_balance User read own customer balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: customer_payments User read own customer payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_bills User read own daily bills; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: users User read own profile; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quote_items User read own quote items; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: quotes User read own quotes; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions User read own sale transactions (buyer); Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions User read own sale transactions (seller); Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_balance User read own seller balance; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: seller_payments User read own seller payments; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: deleted_records User view own deleted records; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: fcm_device_tokens User view own tokens; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: chalans; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.chalans ENABLE ROW LEVEL SECURITY;

--
-- Name: customer_balance; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.customer_balance ENABLE ROW LEVEL SECURITY;

--
-- Name: customer_payments; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.customer_payments ENABLE ROW LEVEL SECURITY;

--
-- Name: daily_bill_counters; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.daily_bill_counters ENABLE ROW LEVEL SECURITY;

--
-- Name: daily_bills; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.daily_bills ENABLE ROW LEVEL SECURITY;

--
-- Name: deleted_records; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.deleted_records ENABLE ROW LEVEL SECURITY;

--
-- Name: fcm_device_tokens; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.fcm_device_tokens ENABLE ROW LEVEL SECURITY;

--
-- Name: mfc_staff; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: public_registrations; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: sale_transactions; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.sale_transactions ENABLE ROW LEVEL SECURITY;

--
-- Name: seller_balance; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.seller_balance ENABLE ROW LEVEL SECURITY;

--
-- Name: seller_payments; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
\unrestrict 6G3q7YhOPBv6z5lJ5lw8jpOioJAenP0z1V8Ze0XAOANDfbkjhZdZLReGgO3KnW3
